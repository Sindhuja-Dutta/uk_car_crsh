...
#   dimension: accident_cost {
#     hidden: yes
#     type: string
#     case: {
#       when: {
#         sql: cast(${TABLE}.Accident_Severity as int64) = 1 ;;
#         label: "2005664.0"
#       }
#       when: {
#         sql: cast(${TABLE}.Accident_Severity as int64) = 2 ;;
#         label: "229757.0"
#       }
#       when: {
#         sql: cast(${TABLE}.Accident_Severity as int64) = 3 ;;
#         label: "24194.0"
#       }
#     }
#   }

#   measure: accident_cost_sum {
#     type: sum
#     sql: CAST(${accident_cost} as float64) ;;
#   }

#   dimension: accident_cost {
#     type: number
#     sql: (SELECT Cost_per_accident FROM `UK_Car_Crashes.Accident_Costs` WHERE {accident_severity} = `UK_Car_Crashes.Accident_Costs.Accident_casualty_type')  ;;
#     }
...
dimension: time_minutes {
  type: string
  sql: CASE WHEN SUBSTR(${TABLE}.Time,4,2) NOT IN('00', '05', '10', "15","20","25","30","35","40","45","50","55") THEN SUBSTR(${TABLE}.Time,4,2)
    ELSE NULL END;;
}
